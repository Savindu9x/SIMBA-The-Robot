...
*
*******************************************************************************/
void clk4_1_Start(void) 
{
    /* Set the bit to enable the clock. */
    clk4_1_CLKEN |= clk4_1_CLKEN_MASK;
	clk4_1_CLKSTBY |= clk4_1_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: clk4_1_Stop
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clk4_1_Stop(void) 
{
    /* Clear the bit to disable the clock. */
    clk4_1_CLKEN &= (uint8)(~clk4_1_CLKEN_MASK);
	clk4_1_CLKSTBY &= (uint8)(~clk4_1_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: clk4_1_StopBlock
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clk4_1_StopBlock(void) 
{
    if ((clk4_1_CLKEN & clk4_1_CLKEN_MASK) != 0u)
    {
...
#if defined(clk4_1__CFG3)
        CLK_DIST_AMASK = clk4_1_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = clk4_1_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(clk4_1_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(clk4_1_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: clk4_1_StandbyPower
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clk4_1_StandbyPower(uint8 state) 
{
    if(state == 0u)
    {
        clk4_1_CLKSTBY &= (uint8)(~clk4_1_CLKSTBY_MASK);
...
/*******************************************************************************
* Function Name: clk4_1_SetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clk4_1_SetDividerRegister(uint16 clkDivider, uint8 restart)
                                
{
    uint8 enabled;

    uint8 currSrc = clk4_1_GetSourceRegister();
    uint16 oldDivider = clk4_1_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = clk4_1_CLKEN & clk4_1_CLKEN_MASK;
        ...
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((clk4_1_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
...
/*******************************************************************************
* Function Name: clk4_1_GetDividerRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint16 clk4_1_GetDividerRegister(void) 
{
    return CY_GET_REG16(clk4_1_DIV_PTR);
}


/*******************************************************************************
* Function Name: clk4_1_SetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clk4_1_SetModeRegister(uint8 modeBitMask) 
{
    clk4_1_MOD_SRC |= modeBitMask & (uint8)clk4_1_MODE_MASK;
}


/*******************************************************************************
* Function Name: clk4_1_ClearModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clk4_1_ClearModeRegister(uint8 modeBitMask) 
{
    clk4_1_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(clk4_1_MODE_MASK));
}


/*******************************************************************************
* Function Name: clk4_1_GetModeRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 clk4_1_GetModeRegister(void) 
{
    return clk4_1_MOD_SRC & (uint8)(clk4_1_MODE_MASK);
}


/*******************************************************************************
* Function Name: clk4_1_SetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clk4_1_SetSourceRegister(uint8 clkSource) 
{
    uint16 currDiv = clk4_1_GetDividerRegister();
    uint8 oldSrc = clk4_1_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        clk4_1_MOD_SRC |= CYCLK_SSS;
        clk4_1_MOD_SRC =
            (clk4_1_MOD_SRC & (uint8)(~clk4_1_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: clk4_1_GetSourceRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 clk4_1_GetSourceRegister(void) 
{
    return clk4_1_MOD_SRC & clk4_1_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: clk4_1_SetPhaseRegister
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
void clk4_1_SetPhaseRegister(uint8 clkPhase) 
{
    clk4_1_PHASE = clkPhase & clk4_1_PHASE_MASK;
}


/*******************************************************************************
* Function Name: clk4_1_GetPhase
********************************************************************************
*
* Summary:
...
*
*******************************************************************************/
uint8 clk4_1_GetPhaseRegister(void) 
{
    return clk4_1_PHASE & clk4_1_PHASE_MASK;
}
